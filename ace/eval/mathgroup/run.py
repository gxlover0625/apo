...
def parse_args():
    parser = argparse.ArgumentParser(description='Run ACE on math_group')
    ...
    parser.add_argument("--config_path", type=str, default="./eval/mathgroup/data/sample_config.json")
