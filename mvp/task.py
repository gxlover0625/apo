...
def get_eval_fn(dataset_name:str):
    if dataset_name in ["Geo_Group", "BBH_geometric_shapes", "bbeh_geometric_shapes", "Logical_Group", "BBH_logical_deduction_seven_objects", "bbeh_boardgame_qa"]:
        ...
        return gpqa_eval_fn
    elif dataset_name in ["agieval_aqua", "agieval_gaokao_math", "agieval_sat", "math_group", "gaokao_group"]:
        return gpqa_eval_fn
    elif dataset_name in ["agieval_gaokao_history", "agieval_gaokao_chinese", "agieval_gaokao_geography"]:
        return gpqa_eval_fn
