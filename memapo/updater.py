...
class Updater:
    ...
    def update_correct_memory(self, used_templates, question:str=None, ground_truth:str=None, correct_pred:str=None, reflections:list=None, client=None, *args, **kwargs):
        self.ctm.update(used_templates, question, ground_truth, correct_pred, reflections, client, *args, **kwargs)
